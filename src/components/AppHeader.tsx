...
export const AppHeader: React.FC = () => {
  ...
  return (
    <AppBar elevation={0} className="border-b border-gray-300 bg-white static">
      <Toolbar className="flex justify-between min-h-[66px]">
        ...
        <Box className="flex center">
          ...
          <Typography
            variant="body1"
            className="font-playfair font-semibold text-[16px] leading-[14px] tracking-[0.17px] text-[#374151]"
          >
        ...
        <Box className="flex center">
          {/* Location Dropdown */}
          <Button
            startIcon={<LocationOn className="text-[#4B5563]" />}
            endIcon={<ExpandMore className="text-[#4B5563]" />}
            onClick={handleMenuOpen}
            className="text-[13px] text-[#374151] bg-[#F3F4F6] px-[8px] py-[4px] rounded-[6px] min-h-[32px] capitalize"
          >
            {selectedLocation}
          </Button>
          <Menu
