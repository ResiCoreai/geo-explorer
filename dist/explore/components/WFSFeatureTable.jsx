...
export function WFSFeatureTable({ dataset }) {
    ...
    return (<Box className="h-full w-full">
      <DataGrid loading={isLoading} rows={featureAttributes} columns={columns} paginationMode="server" pageSizeOptions={[5, 10, 15]} rowCount={rowCount} paginationModel={paginationModel} onPaginationModelChange={setPaginationModel} className="border-0 [&_.MuiDataGrid-row]:cursor-pointer" onRowClick={(e) => {
