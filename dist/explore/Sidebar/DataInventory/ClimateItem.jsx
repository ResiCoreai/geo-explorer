...
export function ClimateItem({ dataset, climateSelectedOption }) {
    ...
    return (<div className={className('group w-full flex flex-row items-center justify-between text-[14px] border border-solid', 'rounded-md mb-2 transition-all duration-200', {
      ...
      <div className="flex flex-row gap-1 w-full flex-1 items-start ml-2 overflow-hidden">
        ...
        {climateVariableIcons.map(({ type, icon }) => {
            ...
            return 'climate_variable' in dataset.dataset_info &&
                ...
                climateSelectedOption === 'climate_scenario' ? (<div key={type} className="mt-0.5">
        ...
        <div className="flex flex-col min-w-0 overflow-hidden">
          <div className={className('capitalize transition-all', 'overflow-hidden text-ellipsis whitespace-nowrap', 'group-hover:whitespace-normal group-hover:overflow-visible')}>
          ...
          {climateSelectedOption === 'climate_scenario' ? (<div className={className('whitespace-nowrap italic overflow-hidden text-ellipsis capitalize text-[11px]', {
