...
export function getLayerIconByType(layer) {
    var _a;
    const key = layer.data.dataset_info.dataset_type === 'raster'
        ? 'raster'
        : layer.data.dataset_info.feature_type;
    return (_a = layerTypeIcons.find(({ type }) => type === key)) === null || _a === void 0 ? void 0 : _a.icon;
}
export function getLayerIconByCategory(layer) {
    var _a;
    const key = layer.data.dataset_info.dataset_category;
    return (_a = categoryIcons.find(({ type }) => type === key)) === null || _a === void 0 ? void 0 : _a.icon;
}
export function getClimateVariableIcon(layer) {
    var _a, _b;
    if ('climate_variable' in layer.data.dataset_info) {
        const key = (_a = layer.data.dataset_info) === null || _a === void 0 ? void 0 : _a.climate_variable;
        return (_b = climateVariableIcons.find(({ type }) => type === key)) === null || _b === void 0 ? void 0 : _b.icon;
    }
    return null;
}
export function getClimateScenarioIcon(layer) {
    ...
    if ('climate_scenario' in layer.data.dataset_info) {
        const key = (_a = layer.data.dataset_info) === null || _a === void 0 ? void 0 : _a.climate_scenario;
        return (_b = climateScenarioIcons.find(({ type }) => type === key)) === null || _b === void 0 ? void 0 : _b.icon;
    }
    return null;
}
