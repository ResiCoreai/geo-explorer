...
export declare function getLayerIconByType(
  layer: MapLayer,
): ((props: { className?: string }) => ReactNode) | undefined;
export declare function getLayerIconByCategory(
  layer: MapLayer,
): ((props: { className?: string }) => ReactNode) | undefined;
export declare function getClimateVariableIcon(
  layer: MapLayer,
): ((props: { className?: string }) => ReactNode) | null | undefined;
export declare function getClimateScenarioIcon(
  layer: MapLayer,
): ((props: { className?: string }) => ReactNode) | null | undefined;
export {};
