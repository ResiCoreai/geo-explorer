...
export function Item({ index, layer }) {
  ...
  const selected =
    (selectedLayer === null || selectedLayer === void 0
      ? void 0
      : selectedLayer.data.layer_id) === layer.data.layer_id;
  ...
  return _jsxs(
    Box,
    {
      ...
      children: [
        _jsxs(Stack, {
          ...
          children: [
            _jsx(Stack, {
              ...
              children: _jsx(LayerControlIcon, {}),
            }),
            _jsx(Stack, {
              className: "items-center justify-center mx-[6px]",
              children: isClimateData(layer)
                ? _jsx(ClimateLegendIcon, { layer: layer })
                : isCategoricalData(layer)
                  ? _jsx(CategoricalLegendIcon, { layer: layer })
                  : isSingleCategoryData(layer)
                    ? _jsx(SingleLegendIcon, { layer: layer })
                    : (_a = getLayerIconByCategory(layer)) === null ||
                        _a === void 0
                      ? void 0
                      : _a({ className: "w-[18px] h-[18px]" }),
            }),
            _jsx(Typography, {
              className:
                "flex-auto min-w-0 whitespace-nowrap overflow-hidden text-ellipsis text-[14px] font-semibold",
              children: layer.data.display_name,
            }),
            _jsxs(Stack, {
              direction: "row",
              onClick: (e) => {
              ...
              children: [
                _jsx(IconButton, {
                  ...
                  children: _jsx(TableChartOutlinedIcon, {
                    className: "fill-[#13294B8C]",
                  }),
                }),
                _jsx(IconButton, {
                  size: "small",
                  ...
                  onClick: () => {
                    dispatch(
                      toggleVisibility({ layer_id: layer.data.layer_id }),
                    );
                  },
                  children: layer.visible
                    ? _jsx(VisibilityOutlinedIcon, {
                        className: "fill-[#13294B8C]",
                      })
                    : _jsx(VisibilityOffOutlinedIcon, {
                        className: "fill-[#13294B8C]",
                      }),
                }),
                _jsx(IconButton, {
                  size: "small",
                  className: "flex-none text-[#13294B]",
                  children: _jsx(MoreHorizOutlinedIcon, {
                    className: "fill-[#13294B8C]",
                  }),
                }),
              ],
        ...
        selected &&
          isClimateData(layer) &&
          _jsx(ClimateLayerSummary, { layer: layer }),
      ],
    },
    layer.data.layer_id,
  );
