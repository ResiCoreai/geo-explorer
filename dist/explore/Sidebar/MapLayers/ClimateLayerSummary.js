  ...
  return _jsxs(Box, {
    ...
    children: [
      ...
      _jsxs(Stack, {
        ...
        children: [
          _jsxs(Typography, {
            className: "text-[12px] text-[#2C343CCC]",
            children: ["Scenario:", " "],
          }),
          _jsx(Box, { className: "flex-1" }),
          _jsx(Typography, {
            className: "text-[12px] text-[#0455A4] font-semibold",
            children: layer.data.dataset_info.climate_scenario,
          }),
        ],
      }),
      timestamp &&
        _jsxs(Stack, {
          direction: "row",
          className: "my-[6px] text-[#2C343CCC]",
          children: [
            _jsxs(Typography, {
              className: "text-[12px] text-[#2C343CCC]",
              children: ["Timestamp:", " "],
