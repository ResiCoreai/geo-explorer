...
import { FIT_BOUNDS_PADDING, LAYER_SETTINGS_HEIGHT, MAX_ZOOM_LEVEL, SIDEBAR_WIDTH, } from '../../../config';
export function FitBounds() {
    ...
    useEffect(() => {
        if (features.length > 0) {
            ...
            map === null || map === void 0 ? void 0 : map.fitBounds([minX, minY, maxX, maxY], {
                ...
                padding: {
                    ...
                    bottom: (settingsOpen ? LAYER_SETTINGS_HEIGHT : 0) + FIT_BOUNDS_PADDING,
                },
            });
        }
    }, [features]);
