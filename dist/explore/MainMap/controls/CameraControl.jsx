...
export function CameraControl() {
    ...
    return (<div style={{
      ...
      <div>
        <input type="range" min="0" max="85" value={pitch} onChange={handlePitchChange}/>
        <label>Pitch: {pitch.toFixed(2)}°</label>
      </div>
      <div>
        <input type="range" min="0" max="360" step="1" value={bearing} onChange={handleBearingChange}/>
        <label>Bearing: {bearing.toFixed(2)}</label>
      </div>
      <div>
        <input type="range" min="0" max="22" step="0.1" value={zoom} onChange={handleZoomChange}/>
