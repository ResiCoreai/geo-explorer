...
export function LineRipple({ feature }) {
    ...
    useEffect(() => {
        ...
        const update = () => {
            var _a, _b;
            setPoints((_b = (_a = feature.geometry.coordinates) === null || _a === void 0 ? void 0 : _a.map(([lon, lat]) => map.project([lon !== null && lon !== void 0 ? lon : 0, lat !== null && lat !== void 0 ? lat : 0]))) !== null && _b !== void 0 ? _b : []);
        };
        map.on('zoom', update);
        map.on('move', update);
        update();
