    ...
    return (<>
      <defs>
        <filter id={filterId} x="-100%" y="-100%" width="400%" height="400%">
          <feMorphology id={`${filterId}_outer`} in="SourceAlpha" operator="dilate" radius="0" result="outer"/>
      ...
      <polyline points={points.map((p) => `${p.x},${p.y}`).join(' ')} stroke="black" fill="none" filter={`url(#${filterId})`}/>
