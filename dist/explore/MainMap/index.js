...
export function MainMap() {
    ...
    return (_jsxs(Map, { id: "map", transformRequest: (url) => {
            var _a, _b;
            ...
            zoom: 6,
            pitch: 0,
        }, interactiveLayerIds: ['storage'], onClick: (e) => {
            if (selectedLayer &&
                selectedLayer.data.dataset_info.dataset_type === 'vector') {
                dispatch(identifyFeature(selectedLayer.data.layer_id, e.lngLat, e.target.getZoom()));
            }
        }, cursor: selectedLayer ? 'crosshair' : '', maxPitch: 85, children: [_jsx(NavigationControl, { position: "top-right", visualizePitch: true }), _jsx(FullscreenControl, { position: "top-right" }), _jsx(Source, { type: "raster", tiles: baseMaps.length > 0
                    ? [
                        (_d = (_b = (_a = baseMaps.find((b) => b.layer_id === selectedBaseMap)) === null || _a === void 0 ? void 0 : _a.tile_url_template) !== null && _b !== void 0 ? _b : (_c = baseMaps[0]) === null || _c === void 0 ? void 0 : _c.tile_url_template) !== null && _d !== void 0 ? _d : '',
                    ]
                    : [], tileSize: 256, children: _jsx(Layer, { type: "raster" }) }), mapLayers.map((layer, index) => {
                var _a;
                return (_jsx(WMSLayer, { layer: layer, prevLayer: (_a = mapLayers[index - 1]) !== null && _a !== void 0 ? _a : null }, layer.data.layer_id));
            }), _jsx(RippleOverlay, {}), _jsx(SelectedFeatures, {}), _jsx(FitBounds, {}), selectedLayer && (_jsx("div", { className: "absolute bottom-12 right-3 z-50", children: _jsx(LegendPanel, { layers: mapLayers, selectedLayer: selectedLayer }) }))] }));
}
