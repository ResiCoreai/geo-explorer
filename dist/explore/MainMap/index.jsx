...
export function MainMap() {
    ...
    return (<Map id="map" transformRequest={(url) => {
            var _a, _b;
        ...
        }} cursor={selectedLayer ? 'crosshair' : ''} maxPitch={85}>
      <NavigationControl position="top-right" visualizePitch={true}/>
      <FullscreenControl position="top-right"/>
      <Source type="raster" tiles={baseMaps.length > 0
            ? [
      ...
      {mapLayers.map((layer, index) => {
            var _a;
            return (<WMSLayer key={layer.data.layer_id} layer={layer} prevLayer={(_a = mapLayers[index - 1]) !== null && _a !== void 0 ? _a : null}/>);
        })}
      ...
      {selectedLayer && (<div className="absolute bottom-12 right-3 z-50">
