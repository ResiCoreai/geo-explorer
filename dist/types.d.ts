    ...
    featureTypes: [
        {
            ...
            properties: Array<{
                ...
                nillable: boolean;
                type: string;
                localType: 'Point' | 'MultiPoint' | 'LineString' | 'MultiLineString' | 'Polygon' | 'MultiPolygon';
            }>;
        }
    ];
}
...
export type VectorSymbolizer = PointSymbolizer | LineSymbolizer | PolygonSymbolizer;
export type Symbolizer = PointSymbolizer | LineSymbolizer | PolygonSymbolizer | RasterSymbolizer;
