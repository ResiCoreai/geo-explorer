...
export function makeWMSUrl(options) {
    return (makeUrl(`${GEOSERVER_URL}/wms`, {
        format: 'image/png',
        service: 'WMS',
        version: '1.3.0',
        request: 'GetMap',
...
export async function downloadDataset(name) {
    try {
...
export async function getLegendImageObjectUrl(layerId) {
...
export async function getLegendJSON(layerId) {
