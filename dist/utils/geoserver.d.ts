...
export declare function sendWFSRequest<T>(options: Params, config?: Partial<AxiosRequestConfig>): Promise<AxiosResponse<T>>;
...
export declare function getLegendImageObjectUrl(layerId: string): Promise<string>;
