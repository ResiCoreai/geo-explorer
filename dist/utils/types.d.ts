...
export type DatasetInfo = VectorDatasetInfo | RasterDatasetInfo | ClimateDatasetInfo;
...
export declare function isCategoricalData(layer: MapLayer): layer is MapLayer & {
    data: {
        dataset_info: VectorDatasetInfo;
    };
};
export declare function isSingleCategoryData(layer: MapLayer): layer is MapLayer & {
    data: {
        dataset_info: VectorDatasetInfo;
    };
};
...
export type CategoricalLegend = CategoricalPointLegend | CategoricalLineLegend | CategoricalPolygonLegend;
