...
export declare const initialize: import("@reduxjs/toolkit").AsyncThunk<import("../../utils/types").Metadata, void, {
    state?: unknown;
...
export declare const selectDataset: import("@reduxjs/toolkit").ActionCreatorWithPayload<{
    ...
    layer_id: string | null;
}, "mapLayers/selectMapLayer">, toggleLayerSettings: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<"mapLayers/toggleLayerSettings">, setShowLayerSettings: import("@reduxjs/toolkit").ActionCreatorWithPayload<{
    show: boolean;
}, "mapLayers/setShowLayerSettings">, selectBaseMap: import("@reduxjs/toolkit").ActionCreatorWithPayload<{
    layer_id: string | null;
}, "mapLayers/selectBaseMap">, addLayer: import("@reduxjs/toolkit").ActionCreatorWithPayload<{
    layer_id: string;
}, "mapLayers/addLayer">, removeLayer: import("@reduxjs/toolkit").ActionCreatorWithPayload<{
    layer_id: string;
}, "mapLayers/removeLayer">, reorderStart: import("@reduxjs/toolkit").ActionCreatorWithPayload<{
    index: number;
    ...
    layer_id: string;
    index: number;
}, "mapLayers/setTimestampIdx">, setSelectedFeatures: import("@reduxjs/toolkit").ActionCreatorWithPayload<SimpleFeature[], "mapLayers/setSelectedFeatures">, setLayerStyle: import("@reduxjs/toolkit").ActionCreatorWithPayload<{
    layer_id: string;
    style: MapLayerStyle;
    styleSLD: string;
